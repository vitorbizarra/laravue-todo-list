<template>
    ...
    <div class="px-6 py-2">
        <button class="bg-green-500 px-5 py-2 text-white rounded shadow" @click="toggleModal">Adicionar
            Tarefa</button>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-10 items-stretch w-100 px-6">
    ...
    <base-modal-component modalTitle="Nova Tarefa" :modalActive="modalActive" @close-modal="toggleModal">
        <task-form-component @close-modal="toggleModal"></task-form-component>
